...
<main class="max-w-7xl mx-auto px-6 md:px-8 lg:px-12 py-8 md:py-12 lg:py-16 pt-24">

    <!-- Hero / Header -->
    <section class="space-y-6 mb-16 md:mb-20">
        <h1 class="text-4xl md:text-5xl lg:text-6xl font-extrabold tracking-tight text-on-surface">
            Tips Keselamatan
        </h1>
        <p class="text-lg md:text-xl text-secondary max-w-3xl leading-relaxed">
    ...
    <section class="space-y-8 mb-20" id="banjir">
        <div class="flex items-center space-x-4 border-l-4 border-primary-container pl-4">
            ...
            <h2 class="text-3xl md:text-4xl font-bold">Banjir (Flood)</h2>
        </div>

        <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
            <!-- Sebelum -->
            <div class="bg-primary-container-lowest p-8 md:p-10 rounded-3xl shadow-sm border-b-4 border-tertiary">
                ...
                <p class="text-secondary leading-relaxed">
                    Siapkan <strong>Tas Siaga Bencana</strong> berisi dokumen penting, pakaian ganti, makanan kering, air minum, obat-obatan, dan lampu senter.
                </p>
            ...
            <!-- Saat -->
            <div class="bg-primary-container-lowest p-8 md:p-10 rounded-3xl shadow-sm border-b-4 border-primary-container">
                <div class="flex justify-between items-start mb-6">
            ...
            <!-- Sesudah -->
            <div class="lg:col-span-2 bg-primary-container-lowest p-8 md:p-10 rounded-3xl shadow-sm border-b-4 border-secondary flex flex-col lg:flex-row gap-8 items-center">
                <div class="w-full lg:w-2/5">
                    <img src="https://lh3.googleusercontent.com/aida-public/AB6AXuB11QIL_jIyushLVqJElft25o1NM4LWdP_p2JUePNEKdTuvDzbs5Aw-cRsZaBLelXZKt7oCdHX1WcxZKt5LCsxSxdSRudZ_kzevpQsUFRNiKytM7yHfmzzIzmO_BaK8RaISQCPri74Uv8w_InPu0ftZM8k8NTGFoPeLGrDaGEzQP4w9vfLkR4gUTEJfZomqcW-Sol8qL36_viWTUTwnabK7PhVE7KYxG31MVQlioJfStr9h_K-H5C9PoEXmULbqGvle3uhanQC-Fw" 
                         ...
                         class="rounded-3xl w-full h-64 md:h-72 object-cover shadow-md">
                </div>
                <div class="w-full lg:w-3/5 space-y-4">
                    <h3 class="text-2xl font-bold">Sesudah: Higienitas &amp; Pemulihan</h3>
                    <p class="text-secondary">
                        Bersihkan rumah segera setelah air surut. Gunakan desinfektan untuk mencegah penyakit yang ditularkan melalui air.
                    </p>
    ...
    <section class="space-y-8 mb-20" id="gempa">
        <div class="flex items-center space-x-4 border-l-4 border-primary-container pl-4">
            ...
            <h2 class="text-3xl md:text-4xl font-bold">Gempa Bumi (Earthquake)</h2>
        </div>
            ...
            <div class="bg-primary-container-lowest p-8 md:p-12 rounded-3xl space-y-12">
                <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                    ...
                    <div class="text-center space-y-4">
                        ...
                        <p class="text-sm text-secondary">Tetap bertahan di posisi hingga guncangan berhenti.</p>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-10 pt-8 border-t border-primary-container-high">
                    <div class="space-y-4">
                        <h4 class="text-primary-container font-bold flex items-center gap-2 text-lg">
                            <span class="material-symbols-outlined">home</span> Identifikasi Titik Aman
                        </h4>
                        <ul class="text-sm text-secondary space-y-2 list-disc pl-5">
                            ...
                            <li>Area terbuka jauh dari gedung atau pohon.</li>
                        </ul>
                    </div>
                    <div class="space-y-4">
                        <h4 class="text-primary-container font-bold flex items-center gap-2 text-lg">
                            <span class="material-symbols-outlined">exit_to_app</span> Prosedur Evakuasi
                        </h4>
                        <ul class="text-sm text-secondary space-y-2 list-disc pl-5">
    ...
    <section class="space-y-8 mb-20" id="longsor">
        <div class="flex items-center space-x-4 border-l-4 border-primary-container pl-4">
            ...
            <h2 class="text-3xl md:text-4xl font-bold">Tanah Longsor (Landslide)</h2>
        </div>
        ...
        <div class="bg-primary-container-low rounded-3xl p-8 lg:p-12">
            <div class="flex flex-col lg:flex-row gap-12">
                <div class="lg:w-1/2 space-y-6">
                    ...
                    <p class="text-secondary leading-relaxed">
                        Khususnya warga di kawasan Plaosan, Poncol, dan lereng Gunung Lawu.
                    </p>
                    ...
                    <div class="space-y-4">
                        ...
                        <div class="flex gap-4 p-5 bg-primary-container-lowest rounded-2xl border-l-4 border-primary-container">
                            ...
                            <div>
                                ...
                                <p class="text-sm text-secondary">Pohon atau tiang listrik yang tiba-tiba condong.</p>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="lg:w-1/2 relative rounded-3xl overflow-hidden min-h-[320px]">
                    ...
                    <div class="absolute bottom-6 left-6 right-6 bg-white/95 backdrop-blur-md p-6 rounded-2xl">
                        <h5 class="font-bold text-primary-container flex items-center gap-2 mb-2">
                            <span class="material-symbols-outlined">route</span> Rute Evakuasi
                        </h5>
                        <p class="text-sm text-on-surface">
                            Segera menjauh dari lereng menuju area datar yang stabil.
                        </p>
                    </div>
                </div>
            </div>
    ...
    <section class="space-y-8 mb-20" id="gunungapi">
        <div class="flex items-center space-x-4 border-l-4 border-primary-container pl-4">
            ...
            <h2 class="text-3xl md:text-4xl font-bold">Abu Vulkanik (Gunung Api)</h2>
        </div>

        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div class="bg-surface-container-lowest p-8 md:p-10 rounded-3xl shadow-sm border-b-4 border-primary-container">
                ...
                <p class="text-secondary mb-6">Paparan abu vulkanik dapat mengganggu pernapasan dan mata.</p>
                <div class="grid grid-cols-2 gap-4">
                    <div class="bg-surface-container p-6 rounded-2xl text-center">
                        ...
                        <p class="font-semibold text-sm">Masker N95</p>
                    </div>
                    <div class="bg-surface-container p-6 rounded-2xl text-center">
                        <span class="material-symbols-outlined text-4xl text-primary-container mb-2 block">visibility</span>
                        <p class="font-semibold text-sm">Kacamata Pelindung</p>
                    </div>
                </div>
            </div>

            <div class="bg-surface-container-lowest p-8 md:p-10 rounded-3xl shadow-sm border-b-4 border-tertiary">
                <h4 class="font-bold text-xl flex items-center gap-3 mb-4">
                    <span class="material-symbols-outlined text-tertiary">monitor_heart</span>
                    Pantau Status Gunung Lawu
                </h4>
                <p class="text-secondary">
                    Selalu perbarui informasi melalui situs resmi <strong>Magma Indonesia</strong> atau <strong>BPBD Kabupaten Magetan</strong>.
                </p>
                <a href="https://bpbd.magetan.go.id/" class="inline-flex items-center mt-6 text-tertiary font-bold hover:underline">
                    Cek Status Terkini <span class="material-symbols-outlined ml-1">open_in_new</span>
                </a>
            </div>
        </div>
    </section>
