...
@section('title', 'Kelola Submenu Kebencanaan')
  ...
  <div class="d-flex justify-content-between align-items-center mb-4 border-bottom pb-3">
    <div>
      <ol class="breadcrumb mb-0">
        <li class="text-black text-2xl font-bold"> Daftar Submenu Kebencanaan
        </li>
      </ol>
    </div>
    <div>
      <a href="{{ route('admin.kebencanaan-submenu.create') }}" class="btn btn-soft-danger btn-sm">
