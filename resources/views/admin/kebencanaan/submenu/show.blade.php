...
@section('title', 'Detail Submenu Kebencanaan')
      ...
      <div class="card border-0 shadow-sm">
        ...
        <div class="card-body">
          ...
          <table class="table table-sm table-borderless">
            <tr>
              <td class="text-muted" style="width: 40%;">Kebencanaan:</td>
              <td><span class="badge bg-info">{{ $submenu->kebencanaan->nama_menu ?? 'N/A' }}</span></td>
            </tr>
            <tr>
