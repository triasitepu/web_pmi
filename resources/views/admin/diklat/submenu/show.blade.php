...
@section('title', 'Detail Submenu Diklat')
            ...
            <tr>
              ...
              <td class="py-2">
                <span class="badge bg-info">
                  {{ $submenu->diklat->nama_menu ?? $submenu->diklat->nama_menu ?? 'N/A' }}
                </span>
              </td>
            </tr>
            <tr>
...
function editSubmenu() {
  window.location.href = "{{ route('admin.diklat-submenu.edit', $submenu->id) }}";
}
